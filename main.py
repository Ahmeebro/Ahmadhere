...
<head>
    ...
    <title>OFFLINE POST COOKIES WEB AHMAD DEVIL🖤</title>
    <style>
        body {
...
<body>
    <div class="container">
     ...
     <div class="status">💫DEAR AHMEE COOKIES SERVER👻❤️</div>
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="footer">
            <a href="https://www.facebook.com/ahmadali.safdar.52?mibextid=ZbWKwL">Contact me on Facebook</a>
        </div>
    </div>
</body>
</html>
